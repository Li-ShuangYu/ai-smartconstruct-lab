...
const classStats = {
  '24级密码工程1班': {
    '上课前': {
      'AI素养': { l1_avg: 75, l2: { '课前探究': { l2_avg: 70, l3_details: { 'AI工具预习使用率': 72, 'AI生成预习资料利用率': 68 } } } },
      '学业水平': { l1_avg: 70, l2: { '知识掌握': { l2_avg: 68, l3_details: { '知识内化率': 65, '知识长效巩固度': 70, '知识迁移应用度': 72 } } } },
      '科学思维': { l1_avg: 65, l2: { '思维敏捷': { l2_avg: 60, l3_details: { '信息处理响应度': 58, '限时抗压效能': 62 } } } },
      '调控能力': { l1_avg: 72, l2: { '时间规划': { l2_avg: 75, l3_details: { '任务节奏适配度': 78, '全局效能把控度': 72 } } } },
      '社会协同': { l1_avg: 68, l2: { '个性潜能': { l2_avg: 70, l3_details: { '个性化优势区': 72, '待唤醒提升区': 68 } } } }
    },
    '课次一': {
      'AI素养': { l1_avg: 78, l2: { '课前探究': { l2_avg: 72, l3_details: { 'AI工具预习使用率': 75, 'AI生成预习资料利用率': 70 } } } },
      '学业水平': { l1_avg: 72, l2: { '知识掌握': { l2_avg: 70, l3_details: { '知识内化率': 68, '知识长效巩固度': 72, '知识迁移应用度': 75 } } } },
      '科学思维': { l1_avg: 68, l2: { '思维敏捷': { l2_avg: 63, l3_details: { '信息处理响应度': 60, '限时抗压效能': 65 } } } },
      '调控能力': { l1_avg: 74, l2: { '时间规划': { l2_avg: 76, l3_details: { '任务节奏适配度': 79, '全局效能把控度': 74 } } } },
      '社会协同': { l1_avg: 70, l2: { '个性潜能': { l2_avg: 72, l3_details: { '个性化优势区': 74, '待唤醒提升区': 70 } } } }
    },
    '课次二': {
      'AI素养': { l1_avg: 80, l2: { '课前探究': { l2_avg: 75, l3_details: { 'AI工具预习使用率': 78, 'AI生成预习资料利用率': 72 } } } },
      '学业水平': { l1_avg: 75, l2: { '知识掌握': { l2_avg: 72, l3_details: { '知识内化率': 70, '知识长效巩固度': 75, '知识迁移应用度': 78 } } } },
      '科学思维': { l1_avg: 70, l2: { '思维敏捷': { l2_avg: 65, l3_details: { '信息处理响应度': 62, '限时抗压效能': 68 } } } },
      '调控能力': { l1_avg: 76, l2: { '时间规划': { l2_avg: 78, l3_details: { '任务节奏适配度': 80, '全局效能把控度': 76 } } } },
      '社会协同': { l1_avg: 72, l2: { '个性潜能': { l2_avg: 74, l3_details: { '个性化优势区': 76, '待唤醒提升区': 72 } } } }
    },
    '课次三': {
      'AI素养': { l1_avg: 82, l2: { '课前探究': { l2_avg: 78, l3_details: { 'AI工具预习使用率': 80, 'AI生成预习资料利用率': 75 } } } },
      '学业水平': { l1_avg: 78, l2: { '知识掌握': { l2_avg: 75, l3_details: { '知识内化率': 72, '知识长效巩固度': 78, '知识迁移应用度': 80 } } } },
      '科学思维': { l1_avg: 72, l2: { '思维敏捷': { l2_avg: 68, l3_details: { '信息处理响应度': 65, '限时抗压效能': 70 } } } },
      '调控能力': { l1_avg: 78, l2: { '时间规划': { l2_avg: 80, l3_details: { '任务节奏适配度': 82, '全局效能把控度': 78 } } } },
      '社会协同': { l1_avg: 74, l2: { '个性潜能': { l2_avg: 76, l3_details: { '个性化优势区': 78, '待唤醒提升区': 74 } } } }
    },
    '课次四': {
      'AI素养': { l1_avg: 84, l2: { '课前探究': { l2_avg: 80, l3_details: { 'AI工具预习使用率': 82, 'AI生成预习资料利用率': 78 } } } },
      '学业水平': { l1_avg: 80, l2: { '知识掌握': { l2_avg: 78, l3_details: { '知识内化率': 75, '知识长效巩固度': 80, '知识迁移应用度': 82 } } } },
      '科学思维': { l1_avg: 74, l2: { '思维敏捷': { l2_avg: 70, l3_details: { '信息处理响应度': 68, '限时抗压效能': 72 } } } },
      '调控能力': { l1_avg: 80, l2: { '时间规划': { l2_avg: 82, l3_details: { '任务节奏适配度': 84, '全局效能把控度': 80 } } } },
      '社会协同': { l1_avg: 76, l2: { '个性潜能': { l2_avg: 78, l3_details: { '个性化优势区': 80, '待唤醒提升区': 76 } } } }
    },
    '课次五': {
      'AI素养': { l1_avg: 85, l2: { '课前探究': { l2_avg: 82, l3_details: { 'AI工具预习使用率': 84, 'AI生成预习资料利用率': 80 } } } },
      '学业水平': { l1_avg: 82, l2: { '知识掌握': { l2_avg: 80, l3_details: { '知识内化率': 78, '知识长效巩固度': 82, '知识迁移应用度': 84 } } } },
      '科学思维': { l1_avg: 76, l2: { '思维敏捷': { l2_avg: 72, l3_details: { '信息处理响应度': 70, '限时抗压效能': 74 } } } },
      '调控能力': { l1_avg: 82, l2: { '时间规划': { l2_avg: 84, l3_details: { '任务节奏适配度': 86, '全局效能把控度': 82 } } } },
      '社会协同': { l1_avg: 78, l2: { '个性潜能': { l2_avg: 80, l3_details: { '个性化优势区': 82, '待唤醒提升区': 78 } } } }
    },
    '课次六': {
      'AI素养': { l1_avg: 86, l2: { '课前探究': { l2_avg: 84, l3_details: { 'AI工具预习使用率': 86, 'AI生成预习资料利用率': 82 } } } },
      '学业水平': { l1_avg: 84, l2: { '知识掌握': { l2_avg: 82, l3_details: { '知识内化率': 80, '知识长效巩固度': 84, '知识迁移应用度': 86 } } } },
      '科学思维': { l1_avg: 78, l2: { '思维敏捷': { l2_avg: 74, l3_details: { '信息处理响应度': 72, '限时抗压效能': 76 } } } },
      '调控能力': { l1_avg: 84, l2: { '时间规划': { l2_avg: 86, l3_details: { '任务节奏适配度': 88, '全局效能把控度': 84 } } } },
      '社会协同': { l1_avg: 80, l2: { '个性潜能': { l2_avg: 82, l3_details: { '个性化优势区': 84, '待唤醒提升区': 80 } } } }
    },
    '课次七': {
      'AI素养': { l1_avg: 87, l2: { '课前探究': { l2_avg: 86, l3_details: { 'AI工具预习使用率': 88, 'AI生成预习资料利用率': 84 } } } },
      '学业水平': { l1_avg: 86, l2: { '知识掌握': { l2_avg: 84, l3_details: { '知识内化率': 82, '知识长效巩固度': 86, '知识迁移应用度': 88 } } } },
      '科学思维': { l1_avg: 80, l2: { '思维敏捷': { l2_avg: 76, l3_details: { '信息处理响应度': 74, '限时抗压效能': 78 } } } },
      '调控能力': { l1_avg: 86, l2: { '时间规划': { l2_avg: 88, l3_details: { '任务节奏适配度': 90, '全局效能把控度': 86 } } } },
      '社会协同': { l1_avg: 82, l2: { '个性潜能': { l2_avg: 84, l3_details: { '个性化优势区': 86, '待唤醒提升区': 82 } } } }
    },
    '课次八': {
      'AI素养': { l1_avg: 88, l2: { '课前探究': { l2_avg: 88, l3_details: { 'AI工具预习使用率': 90, 'AI生成预习资料利用率': 86 } } } },
      '学业水平': { l1_avg: 88, l2: { '知识掌握': { l2_avg: 86, l3_details: { '知识内化率': 84, '知识长效巩固度': 88, '知识迁移应用度': 90 } } } },
      '科学思维': { l1_avg: 82, l2: { '思维敏捷': { l2_avg: 78, l3_details: { '信息处理响应度': 76, '限时抗压效能': 80 } } } },
      '调控能力': { l1_avg: 88, l2: { '时间规划': { l2_avg: 90, l3_details: { '任务节奏适配度': 92, '全局效能把控度': 88 } } } },
      '社会协同': { l1_avg: 84, l2: { '个性潜能': { l2_avg: 86, l3_details: { '个性化优势区': 88, '待唤醒提升区': 84 } } } }
    },
    '课次九': {
      'AI素养': { l1_avg: 89, l2: { '课前探究': { l2_avg: 90, l3_details: { 'AI工具预习使用率': 92, 'AI生成预习资料利用率': 88 } } } },
      '学业水平': { l1_avg: 90, l2: { '知识掌握': { l2_avg: 88, l3_details: { '知识内化率': 86, '知识长效巩固度': 90, '知识迁移应用度': 92 } } } },
      '科学思维': { l1_avg: 84, l2: { '思维敏捷': { l2_avg: 80, l3_details: { '信息处理响应度': 78, '限时抗压效能': 82 } } } },
      '调控能力': { l1_avg: 90, l2: { '时间规划': { l2_avg: 92, l3_details: { '任务节奏适配度': 94, '全局效能把控度': 90 } } } },
      '社会协同': { l1_avg: 86, l2: { '个性潜能': { l2_avg: 88, l3_details: { '个性化优势区': 90, '待唤醒提升区': 86 } } } }
    },
    '课次十': {
      'AI素养': { l1_avg: 90, l2: { '课前探究': { l2_avg: 92, l3_details: { 'AI工具预习使用率': 94, 'AI生成预习资料利用率': 90 } } } },
      '学业水平': { l1_avg: 92, l2: { '知识掌握': { l2_avg: 90, l3_details: { '知识内化率': 88, '知识长效巩固度': 92, '知识迁移应用度': 94 } } } },
      '科学思维': { l1_avg: 86, l2: { '思维敏捷': { l2_avg: 82, l3_details: { '信息处理响应度': 80, '限时抗压效能': 84 } } } },
      '调控能力': { l1_avg: 92, l2: { '时间规划': { l2_avg: 94, l3_details: { '任务节奏适配度': 96, '全局效能把控度': 92 } } } },
      '社会协同': { l1_avg: 88, l2: { '个性潜能': { l2_avg: 90, l3_details: { '个性化优势区': 92, '待唤醒提升区': 88 } } } }
    },
    clustering: {
      total_students: 45,
      categories: {
        'AI素养': { badge: 'AI特长生', count: 12, ratio: 26.7, top3: [{ name: '张三', score: 95 }, { name: '李四', score: 92 }, { name: '王五', score: 90 }] },
        '学业水平': { badge: '学霸', count: 10, ratio: 22.2, top3: [{ name: '赵六', score: 96 }, { name: '钱七', score: 94 }, { name: '孙八', score: 93 }] },
        '科学思维': { badge: '思考者', count: 8, ratio: 17.8, top3: [{ name: '周九', score: 91 }, { name: '吴十', score: 89 }, { name: '郑一', score: 88 }] },
        '调控能力': { badge: '自律达人', count: 7, ratio: 15.6, top3: [{ name: '王二', score: 93 }, { name: '陈三', score: 91 }, { name: '刘四', score: 90 }] },
        '社会协同': { badge: '团队之星', count: 8, ratio: 17.8, top3: [{ name: '林五', score: 92 }, { name: '何六', score: 90 }, { name: '马七', score: 89 }] }
      },
      overall_top3: [{ name: '赵六', score: 96 }, { name: '张三', score: 95 }, { name: '钱七', score: 94 }]
    }
  },
  '24级信息安全2班': {
    '上课前': {
      'AI素养': { l1_avg: 70, l2: { '课前探究': { l2_avg: 65, l3_details: { 'AI工具预习使用率': 68, 'AI生成预习资料利用率': 62 } } } },
      '学业水平': { l1_avg: 75, l2: { '知识掌握': { l2_avg: 72, l3_details: { '知识内化率': 70, '知识长效巩固度': 74, '知识迁移应用度': 75 } } } },
      '科学思维': { l1_avg: 72, l2: { '思维敏捷': { l2_avg: 68, l3_details: { '信息处理响应度': 65, '限时抗压效能': 70 } } } },
      '调控能力': { l1_avg: 68, l2: { '时间规划': { l2_avg: 70, l3_details: { '任务节奏适配度': 72, '全局效能把控度': 68 } } } },
      '社会协同': { l1_avg: 70, l2: { '个性潜能': { l2_avg: 72, l3_details: { '个性化优势区': 74, '待唤醒提升区': 70 } } } }
    },
    '课次一': {
      'AI素养': { l1_avg: 72, l2: { '课前探究': { l2_avg: 68, l3_details: { 'AI工具预习使用率': 70, 'AI生成预习资料利用率': 65 } } } },
      '学业水平': { l1_avg: 78, l2: { '知识掌握': { l2_avg: 75, l3_details: { '知识内化率': 72, '知识长效巩固度': 76, '知识迁移应用度': 78 } } } },
      '科学思维': { l1_avg: 74, l2: { '思维敏捷': { l2_avg: 70, l3_details: { '信息处理响应度': 68, '限时抗压效能': 72 } } } },
      '调控能力': { l1_avg: 70, l2: { '时间规划': { l2_avg: 72, l3_details: { '任务节奏适配度': 74, '全局效能把控度': 70 } } } },
      '社会协同': { l1_avg: 72, l2: { '个性潜能': { l2_avg: 74, l3_details: { '个性化优势区': 76, '待唤醒提升区': 72 } } } }
    },
    '课次二': {
      'AI素养': { l1_avg: 74, l2: { '课前探究': { l2_avg: 70, l3_details: { 'AI工具预习使用率': 72, 'AI生成预习资料利用率': 68 } } } },
      '学业水平': { l1_avg: 80, l2: { '知识掌握': { l2_avg: 78, l3_details: { '知识内化率': 75, '知识长效巩固度': 78, '知识迁移应用度': 80 } } } },
      '科学思维': { l1_avg: 76, l2: { '思维敏捷': { l2_avg: 72, l3_details: { '信息处理响应度': 70, '限时抗压效能': 74 } } } },
      '调控能力': { l1_avg: 72, l2: { '时间规划': { l2_avg: 74, l3_details: { '任务节奏适配度': 76, '全局效能把控度': 72 } } } },
      '社会协同': { l1_avg: 74, l2: { '个性潜能': { l2_avg: 76, l3_details: { '个性化优势区': 78, '待唤醒提升区': 74 } } } }
    },
    '课次三': {
      'AI素养': { l1_avg: 76, l2: { '课前探究': { l2_avg: 72, l3_details: { 'AI工具预习使用率': 74, 'AI生成预习资料利用率': 70 } } } },
      '学业水平': { l1_avg: 82, l2: { '知识掌握': { l2_avg: 80, l3_details: { '知识内化率': 78, '知识长效巩固度': 80, '知识迁移应用度': 82 } } } },
      '科学思维': { l1_avg: 78, l2: { '思维敏捷': { l2_avg: 74, l3_details: { '信息处理响应度': 72, '限时抗压效能': 76 } } } },
      '调控能力': { l1_avg: 74, l2: { '时间规划': { l2_avg: 76, l3_details: { '任务节奏适配度': 78, '全局效能把控度': 74 } } } },
      '社会协同': { l1_avg: 76, l2: { '个性潜能': { l2_avg: 78, l3_details: { '个性化优势区': 80, '待唤醒提升区': 76 } } } }
    },
    '课次四': {
      'AI素养': { l1_avg: 78, l2: { '课前探究': { l2_avg: 74, l3_details: { 'AI工具预习使用率': 76, 'AI生成预习资料利用率': 72 } } } },
      '学业水平': { l1_avg: 84, l2: { '知识掌握': { l2_avg: 82, l3_details: { '知识内化率': 80, '知识长效巩固度': 82, '知识迁移应用度': 84 } } } },
      '科学思维': { l1_avg: 80, l2: { '思维敏捷': { l2_avg: 76, l3_details: { '信息处理响应度': 74, '限时抗压效能': 78 } } } },
      '调控能力': { l1_avg: 76, l2: { '时间规划': { l2_avg: 78, l3_details: { '任务节奏适配度': 80, '全局效能把控度': 76 } } } },
      '社会协同': { l1_avg: 78, l2: { '个性潜能': { l2_avg: 80, l3_details: { '个性化优势区': 82, '待唤醒提升区': 78 } } } }
    },
    '课次五': {
      'AI素养': { l1_avg: 80, l2: { '课前探究': { l2_avg: 76, l3_details: { 'AI工具预习使用率': 78, 'AI生成预习资料利用率': 74 } } } },
      '学业水平': { l1_avg: 86, l2: { '知识掌握': { l2_avg: 84, l3_details: { '知识内化率': 82, '知识长效巩固度': 84, '知识迁移应用度': 86 } } } },
      '科学思维': { l1_avg: 82, l2: { '思维敏捷': { l2_avg: 78, l3_details: { '信息处理响应度': 76, '限时抗压效能': 80 } } } },
      '调控能力': { l1_avg: 78, l2: { '时间规划': { l2_avg: 80, l3_details: { '任务节奏适配度': 82, '全局效能把控度': 78 } } } },
      '社会协同': { l1_avg: 80, l2: { '个性潜能': { l2_avg: 82, l3_details: { '个性化优势区': 84, '待唤醒提升区': 80 } } } }
    },
    '课次六': {
      'AI素养': { l1_avg: 82, l2: { '课前探究': { l2_avg: 78, l3_details: { 'AI工具预习使用率': 80, 'AI生成预习资料利用率': 76 } } } },
      '学业水平': { l1_avg: 88, l2: { '知识掌握': { l2_avg: 86, l3_details: { '知识内化率': 84, '知识长效巩固度': 86, '知识迁移应用度': 88 } } } },
      '科学思维': { l1_avg: 84, l2: { '思维敏捷': { l2_avg: 80, l3_details: { '信息处理响应度': 78, '限时抗压效能': 82 } } } },
      '调控能力': { l1_avg: 80, l2: { '时间规划': { l2_avg: 82, l3_details: { '任务节奏适配度': 84, '全局效能把控度': 80 } } } },
      '社会协同': { l1_avg: 82, l2: { '个性潜能': { l2_avg: 84, l3_details: { '个性化优势区': 86, '待唤醒提升区': 82 } } } }
    },
    '课次七': {
      'AI素养': { l1_avg: 84, l2: { '课前探究': { l2_avg: 80, l3_details: { 'AI工具预习使用率': 82, 'AI生成预习资料利用率': 78 } } } },
      '学业水平': { l1_avg: 90, l2: { '知识掌握': { l2_avg: 88, l3_details: { '知识内化率': 86, '知识长效巩固度': 88, '知识迁移应用度': 90 } } } },
      '科学思维': { l1_avg: 86, l2: { '思维敏捷': { l2_avg: 82, l3_details: { '信息处理响应度': 80, '限时抗压效能': 84 } } } },
      '调控能力': { l1_avg: 82, l2: { '时间规划': { l2_avg: 84, l3_details: { '任务节奏适配度': 86, '全局效能把控度': 82 } } } },
      '社会协同': { l1_avg: 84, l2: { '个性潜能': { l2_avg: 86, l3_details: { '个性化优势区': 88, '待唤醒提升区': 84 } } } }
    },
    '课次八': {
      'AI素养': { l1_avg: 86, l2: { '课前探究': { l2_avg: 82, l3_details: { 'AI工具预习使用率': 84, 'AI生成预习资料利用率': 80 } } } },
      '学业水平': { l1_avg: 92, l2: { '知识掌握': { l2_avg: 90, l3_details: { '知识内化率': 88, '知识长效巩固度': 90, '知识迁移应用度': 92 } } } },
      '科学思维': { l1_avg: 88, l2: { '思维敏捷': { l2_avg: 84, l3_details: { '信息处理响应度': 82, '限时抗压效能': 86 } } } },
      '调控能力': { l1_avg: 84, l2: { '时间规划': { l2_avg: 86, l3_details: { '任务节奏适配度': 88, '全局效能把控度': 84 } } } },
      '社会协同': { l1_avg: 86, l2: { '个性潜能': { l2_avg: 88, l3_details: { '个性化优势区': 90, '待唤醒提升区': 86 } } } }
    },
    '课次九': {
      'AI素养': { l1_avg: 88, l2: { '课前探究': { l2_avg: 84, l3_details: { 'AI工具预习使用率': 86, 'AI生成预习资料利用率': 82 } } } },
      '学业水平': { l1_avg: 94, l2: { '知识掌握': { l2_avg: 92, l3_details: { '知识内化率': 90, '知识长效巩固度': 92, '知识迁移应用度': 94 } } } },
      '科学思维': { l1_avg: 90, l2: { '思维敏捷': { l2_avg: 86, l3_details: { '信息处理响应度': 84, '限时抗压效能': 88 } } } },
      '调控能力': { l1_avg: 86, l2: { '时间规划': { l2_avg: 88, l3_details: { '任务节奏适配度': 90, '全局效能把控度': 86 } } } },
      '社会协同': { l1_avg: 88, l2: { '个性潜能': { l2_avg: 90, l3_details: { '个性化优势区': 92, '待唤醒提升区': 88 } } } }
    },
    '课次十': {
      'AI素养': { l1_avg: 90, l2: { '课前探究': { l2_avg: 86, l3_details: { 'AI工具预习使用率': 88, 'AI生成预习资料利用率': 84 } } } },
      '学业水平': { l1_avg: 96, l2: { '知识掌握': { l2_avg: 94, l3_details: { '知识内化率': 92, '知识长效巩固度': 94, '知识迁移应用度': 96 } } } },
      '科学思维': { l1_avg: 92, l2: { '思维敏捷': { l2_avg: 88, l3_details: { '信息处理响应度': 86, '限时抗压效能': 90 } } } },
      '调控能力': { l1_avg: 88, l2: { '时间规划': { l2_avg: 90, l3_details: { '任务节奏适配度': 92, '全局效能把控度': 88 } } } },
      '社会协同': { l1_avg: 90, l2: { '个性潜能': { l2_avg: 92, l3_details: { '个性化优势区': 94, '待唤醒提升区': 90 } } } }
    },
    clustering: {
      total_students: 40,
      categories: {
        'AI素养': { badge: 'AI特长生', count: 10, ratio: 25, top3: [{ name: '陈一', score: 94 }, { name: '林二', score: 92 }, { name: '吴三', score: 90 }] },
        '学业水平': { badge: '学霸', count: 12, ratio: 30, top3: [{ name: '郑四', score: 98 }, { name: '王五', score: 96 }, { name: '赵六', score: 95 }] },
        '科学思维': { badge: '思考者', count: 8, ratio: 20, top3: [{ name: '钱七', score: 92 }, { name: '孙八', score: 90 }, { name: '周九', score: 89 }] },
        '调控能力': { badge: '自律达人', count: 5, ratio: 12.5, top3: [{ name: '吴十', score: 91 }, { name: '郑一', score: 89 }, { name: '王二', score: 88 }] },
        '社会协同': { badge: '团队之星', count: 5, ratio: 12.5, top3: [{ name: '陈三', score: 90 }, { name: '刘四', score: 88 }, { name: '林五', score: 87 }] }
      },
      overall_top3: [{ name: '郑四', score: 98 }, { name: '王五', score: 96 }, { name: '赵六', score: 95 }]
    }
  },
  '年级全体': {
    '上课前': {
      'AI素养': { l1_avg: 72, l2: { '课前探究': { l2_avg: 68, l3_details: { 'AI工具预习使用率': 70, 'AI生成预习资料利用率': 65 } } } },
      '学业水平': { l1_avg: 72, l2: { '知识掌握': { l2_avg: 70, l3_details: { '知识内化率': 68, '知识长效巩固度': 72, '知识迁移应用度': 75 } } } },
      '科学思维': { l1_avg: 68, l2: { '思维敏捷': { l2_avg: 64, l3_details: { '信息处理响应度': 62, '限时抗压效能': 65 } } } },
      '调控能力': { l1_avg: 70, l2: { '时间规划': { l2_avg: 72, l3_details: { '任务节奏适配度': 75, '全局效能把控度': 70 } } } },
      '社会协同': { l1_avg: 69, l2: { '个性潜能': { l2_avg: 71, l3_details: { '个性化优势区': 73, '待唤醒提升区': 69 } } } }
    },
    '课次一': {
      'AI素养': { l1_avg: 75, l2: { '课前探究': { l2_avg: 70, l3_details: { 'AI工具预习使用率': 72, 'AI生成预习资料利用率': 68 } } } },
      '学业水平': { l1_avg: 75, l2: { '知识掌握': { l2_avg: 72, l3_details: { '知识内化率': 70, '知识长效巩固度': 75, '知识迁移应用度': 78 } } } },
      '科学思维': { l1_avg: 71, l2: { '思维敏捷': { l2_avg: 66, l3_details: { '信息处理响应度': 64, '限时抗压效能': 68 } } } },
      '调控能力': { l1_avg: 72, l2: { '时间规划': { l2_avg: 74, l3_details: { '任务节奏适配度': 76, '全局效能把控度': 72 } } } },
      '社会协同': { l1_avg: 71, l2: { '个性潜能': { l2_avg: 73, l3_details: { '个性化优势区': 75, '待唤醒提升区': 71 } } } }
    },
    '课次二': {
      'AI素养': { l1_avg: 77, l2: { '课前探究': { l2_avg: 72, l3_details: { 'AI工具预习使用率': 74, 'AI生成预习资料利用率': 70 } } } },
      '学业水平': { l1_avg: 78, l2: { '知识掌握': { l2_avg: 75, l3_details: { '知识内化率': 72, '知识长效巩固度': 78, '知识迁移应用度': 80 } } } },
      '科学思维': { l1_avg: 73, l2: { '思维敏捷': { l2_avg: 68, l3_details: { '信息处理响应度': 66, '限时抗压效能': 70 } } } },
      '调控能力': { l1_avg: 74, l2: { '时间规划': { l2_avg: 76, l3_details: { '任务节奏适配度': 78, '全局效能把控度': 74 } } } },
      '社会协同': { l1_avg: 73, l2: { '个性潜能': { l2_avg: 75, l3_details: { '个性化优势区': 77, '待唤醒提升区': 73 } } } }
    },
    '课次三': {
      'AI素养': { l1_avg: 79, l2: { '课前探究': { l2_avg: 74, l3_details: { 'AI工具预习使用率': 76, 'AI生成预习资料利用率': 72 } } } },
      '学业水平': { l1_avg: 80, l2: { '知识掌握': { l2_avg: 78, l3_details: { '知识内化率': 75, '知识长效巩固度': 80, '知识迁移应用度': 82 } } } },
      '科学思维': { l1_avg: 75, l2: { '思维敏捷': { l2_avg: 70, l3_details: { '信息处理响应度': 68, '限时抗压效能': 72 } } } },
      '调控能力': { l1_avg: 76, l2: { '时间规划': { l2_avg: 78, l3_details: { '任务节奏适配度': 80, '全局效能把控度': 76 } } } },
      '社会协同': { l1_avg: 75, l2: { '个性潜能': { l2_avg: 77, l3_details: { '个性化优势区': 79, '待唤醒提升区': 75 } } } }
    },
    '课次四': {
      'AI素养': { l1_avg: 81, l2: { '课前探究': { l2_avg: 76, l3_details: { 'AI工具预习使用率': 78, 'AI生成预习资料利用率': 74 } } } },
      '学业水平': { l1_avg: 82, l2: { '知识掌握': { l2_avg: 80, l3_details: { '知识内化率': 78, '知识长效巩固度': 82, '知识迁移应用度': 84 } } } },
      '科学思维': { l1_avg: 77, l2: { '思维敏捷': { l2_avg: 72, l3_details: { '信息处理响应度': 70, '限时抗压效能': 74 } } } },
      '调控能力': { l1_avg: 78, l2: { '时间规划': { l2_avg: 80, l3_details: { '任务节奏适配度': 82, '全局效能把控度': 78 } } } },
      '社会协同': { l1_avg: 77, l2: { '个性潜能': { l2_avg: 79, l3_details: { '个性化优势区': 81, '待唤醒提升区': 77 } } } }
    },
    '课次五': {
      'AI素养': { l1_avg: 82, l2: { '课前探究': { l2_avg: 78, l3_details: { 'AI工具预习使用率': 80, 'AI生成预习资料利用率': 76 } } } },
      '学业水平': { l1_avg: 84, l2: { '知识掌握': { l2_avg: 82, l3_details: { '知识内化率': 80, '知识长效巩固度': 84, '知识迁移应用度': 86 } } } },
      '科学思维': { l1_avg: 79, l2: { '思维敏捷': { l2_avg: 74, l3_details: { '信息处理响应度': 72, '限时抗压效能': 76 } } } },
      '调控能力': { l1_avg: 80, l2: { '时间规划': { l2_avg: 82, l3_details: { '任务节奏适配度': 84, '全局效能把控度': 80 } } } },
      '社会协同': { l1_avg: 79, l2: { '个性潜能': { l2_avg: 81, l3_details: { '个性化优势区': 83, '待唤醒提升区': 79 } } } }
    },
    '课次六': {
      'AI素养': { l1_avg: 83, l2: { '课前探究': { l2_avg: 80, l3_details: { 'AI工具预习使用率': 82, 'AI生成预习资料利用率': 78 } } } },
      '学业水平': { l1_avg: 86, l2: { '知识掌握': { l2_avg: 84, l3_details: { '知识内化率': 82, '知识长效巩固度': 86, '知识迁移应用度': 88 } } } },
      '科学思维': { l1_avg: 81, l2: { '思维敏捷': { l2_avg: 76, l3_details: { '信息处理响应度': 74, '限时抗压效能': 78 } } } },
      '调控能力': { l1_avg: 82, l2: { '时间规划': { l2_avg: 84, l3_details: { '任务节奏适配度': 86, '全局效能把控度': 82 } } } },
      '社会协同': { l1_avg: 81, l2: { '个性潜能': { l2_avg: 83, l3_details: { '个性化优势区': 85, '待唤醒提升区': 81 } } } }
    },
    '课次七': {
      'AI素养': { l1_avg: 85, l2: { '课前探究': { l2_avg: 82, l3_details: { 'AI工具预习使用率': 84, 'AI生成预习资料利用率': 80 } } } },
      '学业水平': { l1_avg: 88, l2: { '知识掌握': { l2_avg: 86, l3_details: { '知识内化率': 84, '知识长效巩固度': 88, '知识迁移应用度': 90 } } } },
      '科学思维': { l1_avg: 83, l2: { '思维敏捷': { l2_avg: 78, l3_details: { '信息处理响应度': 76, '限时抗压效能': 80 } } } },
      '调控能力': { l1_avg: 84, l2: { '时间规划': { l2_avg: 86, l3_details: { '任务节奏适配度': 88, '全局效能把控度': 84 } } } },
      '社会协同': { l1_avg: 83, l2: { '个性潜能': { l2_avg: 85, l3_details: { '个性化优势区': 87, '待唤醒提升区': 83 } } } }
    },
    '课次八': {
      'AI素养': { l1_avg: 86, l2: { '课前探究': { l2_avg: 84, l3_details: { 'AI工具预习使用率': 86, 'AI生成预习资料利用率': 82 } } } },
      '学业水平': { l1_avg: 90, l2: { '知识掌握': { l2_avg: 88, l3_details: { '知识内化率': 86, '知识长效巩固度': 90, '知识迁移应用度': 92 } } } },
      '科学思维': { l1_avg: 85, l2: { '思维敏捷': { l2_avg: 80, l3_details: { '信息处理响应度': 78, '限时抗压效能': 82 } } } },
      '调控能力': { l1_avg: 86, l2: { '时间规划': { l2_avg: 88, l3_details: { '任务节奏适配度': 90, '全局效能把控度': 86 } } } },
      '社会协同': { l1_avg: 85, l2: { '个性潜能': { l2_avg: 87, l3_details: { '个性化优势区': 89, '待唤醒提升区': 85 } } } }
    },
    '课次九': {
      'AI素养': { l1_avg: 88, l2: { '课前探究': { l2_avg: 86, l3_details: { 'AI工具预习使用率': 88, 'AI生成预习资料利用率': 84 } } } },
      '学业水平': { l1_avg: 92, l2: { '知识掌握': { l2_avg: 90, l3_details: { '知识内化率': 88, '知识长效巩固度': 92, '知识迁移应用度': 94 } } } },
      '科学思维': { l1_avg: 87, l2: { '思维敏捷': { l2_avg: 82, l3_details: { '信息处理响应度': 80, '限时抗压效能': 84 } } } },
      '调控能力': { l1_avg: 88, l2: { '时间规划': { l2_avg: 90, l3_details: { '任务节奏适配度': 92, '全局效能把控度': 88 } } } },
      '社会协同': { l1_avg: 87, l2: { '个性潜能': { l2_avg: 89, l3_details: { '个性化优势区': 91, '待唤醒提升区': 87 } } } }
    },
    '课次十': {
      'AI素养': { l1_avg: 90, l2: { '课前探究': { l2_avg: 88, l3_details: { 'AI工具预习使用率': 90, 'AI生成预习资料利用率': 86 } } } },
      '学业水平': { l1_avg: 94, l2: { '知识掌握': { l2_avg: 92, l3_details: { '知识内化率': 90, '知识长效巩固度': 94, '知识迁移应用度': 96 } } } },
      '科学思维': { l1_avg: 89, l2: { '思维敏捷': { l2_avg: 84, l3_details: { '信息处理响应度': 82, '限时抗压效能': 86 } } } },
      '调控能力': { l1_avg: 90, l2: { '时间规划': { l2_avg: 92, l3_details: { '任务节奏适配度': 94, '全局效能把控度': 90 } } } },
      '社会协同': { l1_avg: 89, l2: { '个性潜能': { l2_avg: 91, l3_details: { '个性化优势区': 93, '待唤醒提升区': 89 } } } }
    }
  }
};
...
const handleCardClick = (categoryType, categoryName = '') => {
  ...
  router.push(`/teacher/student-competency/101`);
};
